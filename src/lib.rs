...
use wasi::messaging::messaging_types;
...
impl MessagingTrigger {
    async fn handle_mqtt_event(
        ...
        // instance
        //     .call_handle_message(store, &message, &_types::Metadata { topic })
        //     .await?
...
fn resolve_template_variable(
    _engine: &TriggerAppEngine<MessagingTrigger>,
    _template_string: String,
